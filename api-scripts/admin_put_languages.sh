...
curl -sv -H "Authorization: Token clumeterin" -H 'Content-type: application/json' -X PUT -d '{"name": "js", "version": "latest", "image": "glot/javascript:latest"}' localhost:8090/admin/languages
...
curl -sv -H "Authorization: Token clumeterin" -H 'Content-type: application/json' -X PUT -d '{"name": "c", "version": "latest", "image": "glot/c:latest"}' localhost:8090/admin/languages
curl -sv -H "Authorization: Token clumeterin" -H 'Content-type: application/json' -X PUT -d '{"name": "cpp", "version": "latest", "image": "glot/cpp:latest"}' localhost:8090/admin/languages
